  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-950 font-sans text-gray-100 selection:bg-purple-500/30">
        ...
        {/* Hero Section */}
        <div className="relative pt-40 pb-20 sm:pt-48 sm:pb-24 max-w-7xl mx-auto px-6 lg:px-8 text-center flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full justify-center">
            ...
            {userId ? (
              <Link
                href="/dashboard"
                className="w-full sm:w-auto bg-purple-600 hover:bg-purple-500 border border-purple-500 text-white font-bold py-4 px-8 rounded-2xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-purple-500/20"
              >
                Ir a mis cursos
              </Link>
            ) : (
        ...
        <div className="relative max-w-4xl mx-auto px-6 my-10">
          <div className="bg-gray-900/40 backdrop-blur-xl border border-gray-800 p-8 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-8">
